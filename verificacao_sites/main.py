...
font_color_acessible_button = tk.Button(root, text="☰", fg="black", width=5, height=2, command=toggle_menu_color)
font_color_acessible_button.pack(side=tk.RIGHT, padx=10, pady=10)

font_color_acessible_button.configure(bg="black", fg="white")
